...
mod tests {
    ...
    macro_rules! test_serde {
        ($v: expr) => {
            ...
            let str: String = miniserde::json::to_string(&wrapped_a);
            let deser_a: Base64VecU8 = miniserde::json::from_str(&str).unwrap();
    ...
    fn test_manual() {
        ...
        let a_str = miniserde::json::to_string(&Base64VecU8(a.clone()));
        assert_eq!(a_str, String::from("\"ZHkfFAAXIA==\""));
        let a_deser: Base64VecU8 = miniserde::json::from_str(&a_str).unwrap();
